...
public class Member implements Initializable {
    ...
    void rowClicked(MouseEvent event) {
        Pelanggan klikrow = table.getSelectionModel().getSelectedItem();
        isiNama.setText(String.valueOf(klikrow.getNama()));
        isiGender.setText(String.valueOf(klikrow.getGender()));
        isiAlamat.setText(String.valueOf(klikrow.getAlamat()));
        isiJenis.setText(String.valueOf(klikrow.getJenis()));
